  ...
  const processPayment = async () => {
    ...
    try {
      ...
      const registrationData = {
        ...
        includeSpecialists: (params.includeSpecialists === 'true' || params.includeSpecialists === true) as boolean,
        includePsychology: (params.includePsychology === 'true' || params.includePsychology === true) as boolean,
        includeNutrition: (params.includeNutrition === 'true' || params.includeNutrition === true) as boolean,
